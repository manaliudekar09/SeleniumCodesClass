...
public class WaitForHelper {
    ...
    public boolean inVisibiltyOfElement(final By elementIdentier){
        return new WebDriverWait(driver, Duration.ofSeconds(20)).until(ExpectedConditions.invisibilityOfElementLocated(elementIdentier));
    }
