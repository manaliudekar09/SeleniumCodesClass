...
public class DDTDemo02 {
    ...
    public void testDataDrivenExcel(String email, String password, String expectedResult) {
...
//    }
    ...
    public String[][] testDataExcel() throws IOException {
        ...
        String [][] data;
        data = excelReader.getDataFromSheet(testDataFile,"LoginData");
        return data;
    }
